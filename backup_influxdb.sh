...
mkdir /home/pi/influxdb-backup/$DIR
cd /home/pi/influxdb-backup/$DIR
influxd backup -portable .

# delete all but the last 5 backup folders
#ls -t influx-* | tail -n +6 | xargs rm --
ls -t -d /home/pi/influxdb-backup/influx-* | tail -n +6 | xargs rm -rf 

# backup the backups to usb drive
rsync -a --delete /home/pi/influxdb-backup /mnt/usb
